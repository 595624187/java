...
public class userUpdateFrame extends JFrame{
	...
	public userUpdateFrame() {
		...
		JLabel lblNewLabel = new JLabel("\u8BF7\u8F93\u5165\u65B0\u7528\u6237\u540D");
		lblNewLabel.setBounds(81, 44, 105, 18);
		...
		textField.setBounds(200, 41, 86, 24);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					DataProcessing.updateUser(textField.getText(), textField_1.getText(), new_role);
